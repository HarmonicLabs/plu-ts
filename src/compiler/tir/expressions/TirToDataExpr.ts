...
import { IRApp, IRCase, IRConst, IRConstr, IRFunc, IRHoisted, IRNative, IRTerm, IRVar } from "../../../IR";
...
import { TirBoolT, TirBytesT, TirDataOptT, TirDataT, TirIntT, TirLinearMapT, TirListT, TirSopOptT, TirStringT, TirVoidT } from "../types/TirNativeType";
