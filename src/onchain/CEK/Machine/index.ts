...
import { UPLCTerm, PureUPLCTerm, showUPLC, isUPLCTerm } from "../../UPLC/UPLCTerm";
...
export class Machine<V extends MachineVersion = MachineVersion>
{
    ...
    static evalSimple( _term: UPLCTerm | ToUPLC ): PureUPLCTerm
    {
        return (
            new Machine(
                ScriptType.PlutusV2,
    ...
    static eval( _term: UPLCTerm | ToUPLC ): { result: PureUPLCTerm, budgetSpent: ExBudget, logs: string[] }
    {
        return (
            new Machine(
                ScriptType.PlutusV2,
    ...
    eval( _term: UPLCTerm | ToUPLC ): { result: PureUPLCTerm, budgetSpent: ExBudget, logs: string[] }
    {
    ...
    static evalDebug( _term: UPLCTerm | ToUPLC, opts: Partial<EvalDebugOptions> = {}): { result: PureUPLCTerm, budgetSpent: ExBudget, logs: string[] }
    {
        return (
            new Machine(
                ScriptType.PlutusV2,
    ...
    evalDebug( _term: UPLCTerm | ToUPLC, opts: Partial<EvalDebugOptions> = {}): { result: PureUPLCTerm, budgetSpent: ExBudget, logs: string[] }
    {
        const {
            onComputeStep,
            onReturnStep,
