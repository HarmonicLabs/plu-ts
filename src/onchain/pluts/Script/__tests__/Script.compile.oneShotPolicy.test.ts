...
const ctx = // 66f225ce3f1acd5e9b133a09b571af99ea4f0742741d008e482d3d33a7329da3#0 context
punsafeConvertType(
    pData(
        dataFromCbor(
...
describe("oneShotNFT", () => {
    ...
    test.only("deserializes correctly", () => {
        ...
        const myCompiledDeserialized = UPLCDecoder.parse(
            Buffer.from(
                "",
                "hex"
            ),
            "cbor"
        ).body;
